...
class Tokenizer:
    ...
    def __init__(self, alphabet = "abcdefghijklmnopqrstuvwxyzабвгдеёжзийклмнопрстуфхцчшщъыьэюяәіңғүұқөһ1234567890"):
    ...
    def encode(self, text, tokens_dict_path_e):
        ...
        deliter = "!@#$%^&*()_+=-?/>.<,`|\\\'\"[]{} "
        text = ''.join([char for char in text if char not in deliter])
        text = text.lower()
